...
export default function LoginPage() {
  ...
  return (
    <main style={{ backgroundColor: '#f7f6f2', minHeight: '100vh', fontFamily: 'sans-serif', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      ...
      <div style={{ width: '100%', maxWidth: '360px', backgroundColor: '#fff', borderRadius: '20px', padding: '28px', border: '0.5px solid #e5e4e0' }}>
        ...
        <div style={{ marginBottom: '14px' }}>
          ...
          <input
            ...
            style={{ width: '100%', padding: '12px 14px', borderRadius: '10px', border: '0.5px solid #e5e4e0', fontSize: '14px', backgroundColor: '#f7f6f2', boxSizing: 'border-box', outline: 'none' }}
          />
        </div>
        ...
        <button
          ...
          disabled={loading}
          style={{ width: '100%', backgroundColor: '#FF4500', color: '#fff', border: 'none', borderRadius: '12px', padding: '14px', fontSize: '15px', fontWeight: '800', cursor: 'pointer', marginBottom: '14px' }}
        >
        ...
        <div style={{ textAlign: 'center', fontSize: '13px', color: '#666' }}>
          ...
          <span
            ...
            style={{ color: '#FF4500', fontWeight: '700', cursor: 'pointer' }}
          >
      ...
      <a href="/" style={{ marginTop: '20px', fontSize: '13px', color: '#999', textDecoration: 'none' }}>
        ← Về trang chủ
      </a>
